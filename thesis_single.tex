...
\definecolor{Red}{HTML}{D62728}          % for confusion matrices
\definecolor{Purple}{HTML}{9467BD}       % for confusion matrices
...
\hypersetup{
  pdftitle={Cardiovascular Disease Prediction Using Machine Learning},
  pdfauthor={Sajjad Alam},
  pdfsubject={BS Statistics Thesis},
  pdfkeywords={cardiovascular disease, machine learning, XGBoost, LightGBM, SHAP, FastAPI},
  % Visible (not hidden) clickable links:
  colorlinks=true,
  linkcolor=Accent,
  urlcolor=Accent,
  citecolor=Accent
