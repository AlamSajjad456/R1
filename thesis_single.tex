...
% ==== BEGIN INLINE: thesis_assets/roc_xgboost.tex ====
...
% ==== END INLINE: thesis_assets/roc_xgboost.tex ====
...
% ==== BEGIN INLINE: thesis_assets/threshold_tradeoff.tex ====
...
\addlegendentry{F1}
% ==== END INLINE: thesis_assets/threshold_tradeoff.tex ====
...
% ==== BEGIN INLINE: thesis_assets/feature_importance_xgb.tex ====
% Auto-generated by make_thesis_assets.py
\begin{tikzpicture}
\begin{axis}[
  width=0.92\textwidth,
...
\end{axis}
\end{tikzpicture}
% ==== END INLINE: thesis_assets/feature_importance_xgb.tex ====
